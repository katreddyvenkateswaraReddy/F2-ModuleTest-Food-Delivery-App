document.addEventListener("DOMContentLoaded", function () {
  const recipes = [
    ...
    {
      name: "Paneer Tikka",
      imageSrc: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1917&q=80",
      time: "40 min",
      type: "veg",
      isLiked: false,
      rating: 4.4,
      ...
      recipe.name
            ...
            <div class="recipe-details">
                ...
                <i class="material-icons like-button">${
                  recipe.isLiked ? "favorite" : "favorite_border"
                }</i>
